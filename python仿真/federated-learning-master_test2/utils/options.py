...
def args_parser():
    ...
    parser.add_argument('--active_users', type=int, default=10, help="number of users: K")
    parser.add_argument('--L_h', type=int, default=8, help='RIS Size')
    parser.add_argument('--L_v', type=int, default=8, help='RIS Size')
